...
--
-- Table structure for table `all_tower_servers`
--

DROP TABLE IF EXISTS `all_tower_servers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `all_tower_servers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `all_tower_servers`
--

LOCK TABLES `all_tower_servers` WRITE;
/*!40000 ALTER TABLE `all_tower_servers` DISABLE KEYS */;
/*!40000 ALTER TABLE `all_tower_servers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-03-26  0:47:46
